...
$objCampaignShoot = new CampaignShoot();
...
<body>
    ...
    <div class="rightpanel">
        ...
        <div class="pagetitle">
        	<h1>Create Campaigns Shoot</h1> <span><?php echo $_SESSION['login']; ?> , please enter all the details for the creation of the campaigns management.</span>
        </div><!--pagetitle-->
        ...
        <div class="maincontent">
            ...
            <div class="contentinner">
                ...
                <?php
                     if(isset($_POST['submit_campaign_shoot']))
                         {
                         ?>   <h4 class='confirmation' style="text-align: center" ">The Campaigns Shoot has been created </h4> </br> 
			...
			<div class="widgetcontent">
            	...
            	<h4 class="widgettitle nomargin shadowed">Campaigns Shoot informations</h4>
                    ...
                    <form name="form_advertiser" class="stdform stdform2" method="post" action="" enctype="multipart/form-data">
                       ...
                       <p>
                        ...
                        <p class="stdformbutton">
                            <button type="submit" name="submit_campaign_shoot" id="submit_campaign_shoot" class="btn btn-primary">Create </button>
