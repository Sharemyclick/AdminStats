      ...
      <div class="pagetitle">
        ...
        <div class="maincontent">
            ...
            <table class="table table-bordered" id="dbase">
                    ...
                    <thead>
                        <tr>
							<th class="centeralign">Manager name</th>
							<th class="centeralign">Manager surname</th>
					...
					<tbody>
                                                ...
                                                foreach($viewAffiliateManager->affiliate_managers_list as $list => $affiliate){ ?>         					
                                                        ...
                                                        <tr>
                                                        <td class="centeralign"><a href="update-affiliate-manager.php?id=<?php echo $affiliate['id_affiliate_manager']; ?>" ><?php echo $affiliate['name'] ?></a></td>
