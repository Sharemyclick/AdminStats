...
<div class="mainwrapper">
    ...
    <div class="rightpanel">
      ...
      <div class="pagetitle">
        	<h1>Create Database</h1> <span><?php echo $_SESSION['login']; ?> , please enter all the details for the creation of the Partner.</span>
        </div><!--pagetitle-->
        ...
        <div class="maincontent">
            ...
            <p class="small" style="color:#04B431;">Le partenaire a bien &eacute;t&eacute; cr&eacute;e</p>   
			<p class="small">Cr&eacute;er un autre partenaire en cliquant <a href="create-partner.php">ici</a></p>
