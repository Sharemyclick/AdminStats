                	...
                	<div class="span12">
                    	...
                    	<div class="widgetcontent bordered shadowed nopadding">
							<form name="myForm" id="myForm" class="stdform stdform2" method="POST" action="#">
									...
									<option value="<?php echo $val_jc['id_campaign_management']; ?>"<?php if($val_jc['id_campaign_management'] == $_POST['partner_name']){?> selected <?php } ?>><?php echo $val_jc['name']; ?></option>
									<?php }?>
									</select>
                           ...
                           <select name="allowed" id="type_payout" class="status">
                            ...
                            <select name="conversion" id="type_payout" class="status">
                           ...
                           <select name="device" id="type_payout" class="status">
